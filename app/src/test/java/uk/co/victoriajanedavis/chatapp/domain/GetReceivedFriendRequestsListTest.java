...
public class GetReceivedFriendRequestsListTest extends BaseTest {
    ...
    public void emptyCacheTriggersNetworkFetchAndEmissionOfFetchedItems() {
        new ArrangeBuilder().withReceivedFriendRequestsFromService(ModelGenerationUtil.INSTANCE.createUserNwList(3));
    ...
    public void emptyNetworkFetchEmitsEmptyList() {
        new ArrangeBuilder().withReceivedFriendRequestsFromService(ModelGenerationUtil.INSTANCE.createUserNwList(0));
