...
public class GetChatListTest extends BaseTest {
    ...
    public void emptyCacheTriggersNetworkFetchAndEmissionOfFetchedItems() {
        new ArrangeBuilder().withChatMembershipsFromService(ModelGenerationUtil.INSTANCE.createChatMembershipNwList(3));
    ...
    public void emptyNetworkFetchEmitsEmptyList() {
        new ArrangeBuilder().withChatMembershipsFromService(ModelGenerationUtil.INSTANCE.createChatMembershipNwList(0));
