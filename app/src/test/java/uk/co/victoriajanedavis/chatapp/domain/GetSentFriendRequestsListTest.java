...
public class GetSentFriendRequestsListTest extends BaseTest {
    ...
    public void setUp() {
        ...
        Cache.DiskCache<UUID, ChatDbModel> chatCache = new RecentMessagesCache(database.messageDao());
    ...
    public void emptyCacheTriggersNetworkFetchAndEmissionOfFetchedItems() {
        new ArrangeBuilder().withSentFriendRequestsFromService(ModelGenerationUtil.INSTANCE.createUserNwList(3));
    ...
    public void emptyNetworkFetchEmitsEmptyList() {
        new ArrangeBuilder().withSentFriendRequestsFromService(ModelGenerationUtil.INSTANCE.createUserNwList(0));
