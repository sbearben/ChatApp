...
public class MessageRepositoryTest extends BaseTest {
    ...
    public void fetchedListIsEmittedAfterSubscription() {
        ...
        new ArrangeBuilder().withMessagesFromService(chatDbModel.getUuid(), ModelGenerationUtil.INSTANCE.createMessageNwList(chatDbModel.getUuid(), 3));
    ...
    public void fetchMoreItemsAreStoredAndAppendedToStream() {
        ...
        new ArrangeBuilder().withMoreMessagesFromService(ModelGenerationUtil.INSTANCE.createMessageNwList(chatDbModel.getUuid(), 3));
        createAndStoreMessageDbModels(chatDbModel,3);
